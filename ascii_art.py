...
import pprint
import sys
from colorama import Fore 			# allow for terminal color printing
...
def single_brightness(color_func):
	def single_color_func(r, g, b, invert):
		if invert:
			r = 255-r
			g = 255-g
			b = 255-b
...
if __name__ == "__main__":
	...
	invert = False								# Add into Argparse
	...
	for x in range(width):
		...
		for y in range(height):
			...
			rgb = (r, g, b)
			brightness = color_func(r, g, b, True)
